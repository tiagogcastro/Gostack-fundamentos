<h1 align="center"> Módulo de React Native - nível 1 </h1>
...
<div align="left"> 
  ...
  <p>
    Utilizei o VsCode para fazer os códigos em React Native. 
    </br>
    Utilizei o Axios para consumir a api feita no módulo de NodeJS.
  </p>
  <div>
    <p>
      ➡
      <a href="https://www.typescriptlang.org"> React Native</a>
    </p>
    <p>
      ➡
...
<div align="left">
  ...
  <p> 
    ...
    git clone https://github.com/Tiaguin061/Gostack-ReactNative-nivel1
  </p>
  ...
  <p>➡ Utilize seu dispositivo móvel com cabo USB ligado na máquina ou via Wifi ou baixe Android Studio e configure. Isso tornará possível você visualizar o projeto.</p>
  ...
  <p>
    ...
    yarn ios <-- Inicia o projeto para dispositivos IOS.
    yarn android <-- Inicia o projeto para dispositivos ANDROID. 
  </p>
